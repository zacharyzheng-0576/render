    ...
    for row in rows:
        ...
        for field in ['countries', 'platforms', 'platform_ai_tools', 'traffic_channels', 'biggest_pains']:
            if r.get(field):
                ...
                r[field] = []
        writer.writerow([
            r['created_at'], r['experience'],
            '|'.join(r['countries']), r['revenue'], r['business_type'],
            '|'.join(r['platforms']), r['platform_pain'], r['platform_pain_other'],
            '|'.join(r['platform_ai_tools']), r['platform_ai_tools_other'],
            '|'.join(r['traffic_channels']), r['creative_hours'],
            r['competitor_tracking'], r['competitor_tracking_other'],
            '|'.join(r['biggest_pains']), r['biggest_pains_other'],
            r['willing_to_pay'],
            r['pain_creative'], r['pain_intelligence'], r['pain_multilingual'],
            r['pain_ad_optimize'], r['pain_efficiency'],
            r['ai_tool_gap'], r['ai_tool_gap_other'],
            r['willing_interview'], r['contact_method'], r['contact_info']
        ])
